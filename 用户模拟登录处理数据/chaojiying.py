...
# coding:utf-8
    ...
    # 6004	问答题，智能回答题	15
    # 坐标类返回值 x,y 更多坐标以|分隔,原图左上角0,0 以像率px为单位,x是横轴,y是纵轴
    ...
    # 9005	坐标多选,返回3~5个坐标,如:x1,y1|x2,y2|x3,y3	30
    # 9008	坐标多选,返回5~8个坐标,如:x1,y1|x2,y2|x3,y3|x4,y4|x5,y5	40
...
# 	chaojiying = Chaojiying_Client('18955336286', '199712090054lzg', '915709')	#用户中心>>软件ID 生成一个替换 96001
# 	im = open('./yanzhen/yanzhen.jpg', 'rb').read()													#本地图片文件路径 来替换 a.jpg 有时WIN系统须要//
